...
import { renderWithFallback } from '@/lib/render';
...
function Powered() {
  return (
    <div className='z-10 absolute py-1 rotate-[270deg] left-[-7rem] top-[7rem] rounded-t-md bg-blue-500 px-4 w-[12rem] text-center'>
